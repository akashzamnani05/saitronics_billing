          ...
          return AlertDialog(
            ...
            content: SizedBox(
              ...
              child: availableItems.isEmpty
                  ? const Center(child: Text('No items with stock available'))
                  : ListView.builder(
                      shrinkWrap: true,
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile(
                          ...
                          subtitle: Text(
                            'Stock: ${item.currentStock.toStringAsFixed(0)} | ₹${item.sellingPrice.toStringAsFixed(2)}',
                          ),
...
Future<void> _saveSalesInvoice() async {
  ...
  final transaction = Transaction(
    ...
    paymentMethod: _isMarkedAsPaid ? 'Cash' : null, // You can add payment method selector
  );
